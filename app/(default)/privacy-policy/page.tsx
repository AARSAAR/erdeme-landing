                 ...
                 <span style="font-size: 15px;">
                    <span style="color: rgb(127, 127, 127);">
                       <span data-custom-class="body_text">
                          ...
                          <bdt class="question">info@erdeme.mn</bdt>
                          .
                       </span>
                    </span>
                 </span>
                 ...
                 <span style="font-size: 15px;">
                    <span data-custom-class="body_text">
                       ...
                       <span style="color: rgb(0, 58, 250);">
                          <bdt class="question"><a href="http://www.aarsaar.herokuapp.com/user/me" target="_blank" data-custom-class="link">http://www.aarsaar.herokuapp.com/user/me</a></bdt>
                       </span>
                       <bdt class="else-block"></bdt>
...
<ul>
   <li style="line-height: 1.5;">
      <span data-custom-class="body_text"><span style="font-size: 15px;"><strong>To evaluate and improve our Services, products, marketing, and your experience.</strong> We may process your information when we believe it is necessary to identify usage trends, determine the effectiveness of our promotional campaigns, and to evaluate and improve our Services, products, marketing, and your experience.</span></span>
